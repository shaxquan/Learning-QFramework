...
public class FSMClassDemo : MonoBehaviour
{
    public enum States
    {
        A,
    ...
    public class StateA : AbstractState<States,FSMClassDemo>
    {
        public StateA(FSM<States> fsm, FSMClassDemo target) : base(fsm, target)
        {
        }
    ...
    public class StateB: AbstractState<States,FSMClassDemo>
    {
        public StateB(FSM<States> fsm, FSMClassDemo target) : base(fsm, target)
        {
        }
